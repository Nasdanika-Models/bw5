package org.nasdanika.models.tibco.bw.ecore.tests;
...
import org.nasdanika.models.tibco.bw.ecore.EcoreGenTibcoBwProcessorsFactory;
 ...
 *
 */
public class TestTibcoBwModelDocGen {
	
	@Test
	public void testGenerateTibcoBwModelDoc() throws IOException, DiagnosticException {
		ProgressMonitor progressMonitor = new NullProgressMonitor(); // new PrintStreamProgressMonitor();
		MutableContext context = Context.EMPTY_CONTEXT.fork();
		Consumer<Diagnostic> diagnosticConsumer = d -> d.dump(System.out, 0);
		List<Function<URI,Action>> actionProviders = new ArrayList<>();		
		EcoreGenTibcoBwProcessorsFactory ecoreGenFamilyProcessorFactory = new EcoreGenTibcoBwProcessorsFactory(context);		
