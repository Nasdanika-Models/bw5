package org.nasdanika.models.bw5.ecore;
...
@EPackageNodeProcessorFactory(nsURI = Bw5Package.eNS_URI)
public class EcoreGenBw5ProcessorsFactory {

	private Context context;
		
	public EcoreGenBw5ProcessorsFactory(Context context) {
