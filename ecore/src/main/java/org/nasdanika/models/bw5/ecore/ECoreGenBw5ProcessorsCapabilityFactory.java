...
public class ECoreGenBw5ProcessorsCapabilityFactory implements CapabilityFactory<TargetRequirement, Object> {
		...
		return CompletableFuture.completedStage(
				Collections.singleton(
						CapabilityProvider.of(
								new EcoreGenBw5ProcessorsFactory(requirement.requirement().context()))));
	}
