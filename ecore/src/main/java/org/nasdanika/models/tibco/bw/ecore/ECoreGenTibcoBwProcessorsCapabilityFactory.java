...
public class ECoreGenTibcoBwProcessorsCapabilityFactory implements CapabilityFactory<TargetRequirement, Object> {
		...
		return CompletableFuture.completedStage(
				Collections.singleton(
						CapabilityProvider.of(
								new EcoreGenTibcoBwProcessorsFactory(requirement.requirement().context()))));
	}
