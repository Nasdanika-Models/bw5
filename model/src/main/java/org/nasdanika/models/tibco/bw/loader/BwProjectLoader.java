...
public class BwProjectLoader {
	 ...
	 */
	public BwProjectLoader(ResourceSet resourceSet) {
		this(BwFactory.eINSTANCE, resourceSet);
	}
	 ...
	 */
	public BwProjectLoader(BwFactory factory, ResourceSet resourceSet) {
